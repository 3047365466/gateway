package com.edan.rapid.etcd.core;

import com.edan.rapid.etcd.api.*;
...
public class EtcdClientImpl implements EtcdClient {
	...
	private volatile ConcurrentHashMap<String, EtcdWatcher> etcdWatchers = new ConcurrentHashMap<String, EtcdWatcher>();
